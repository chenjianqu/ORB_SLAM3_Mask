...
bool LoopClosing::NewDetectCommonRegions()
{
    ...
    if(!bMergeDetectedInKF && !vpMergeBowCand.empty())
    {
        mbMergeDetected = DetectCommonRegionsFromBoW(
                vpMergeBowCand, mpMergeMatchedKF, mpMergeLastCurrentKF, mg2oMergeSlw, mnMergeNumCoincidences,
...
void LoopClosing::MergeLocal()
{
    ...
    pNewParent = mpCurrentKF; // Old child, now it will be the parent of its own parent(we need eliminate
    // this KF from children list in its old parent)
...
void LoopClosing::MergeLocal2()
{
    ...
    pNewParent = mpMergeMatchedKF; // Old child, now it will be the parent of its own parent(we need eliminate
    // this KF from children list in its old parent)
