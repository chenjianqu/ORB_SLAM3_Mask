...
def main():
    ...
    root_img_path = '/home/chen/datasets/TUM/rgbd_dataset_freiburg3_walking_xyz/rgb/'
    save_img_path = '/home/chen/datasets/TUM/rgbd_dataset_freiburg3_walking_xyz/mask/'
    ...
    for name in files:
        ...
        img_seq = name_token[0]+"."+name_token[1]
